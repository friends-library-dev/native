...
const resources: EditionResource[] = [
  {
    id: 'a52eb875-8a1a-4f2f-b1b4-650eb3af1126--updated',
    lang: 'en',
    document: {
    ...
    audio: {
      ...
      totalDuration: 2843.5,
      publishedDate: 'Wed Aug 03 2016 00:00:00 GMT-0400 (Eastern Daylight Time)',
      parts: [
        {
          index: 0,
          editionId: 'webb--updated',
          title: 'The Life of Elizabeth Webb',
          utf8ShortTitle: 'The Life of Elizabeth Webb',
          duration: 2843.5,
          size: 26854763,
          sizeLq: 14290634,
          url:
    ...
    chapters: [
      {
        index: 0,
        id: 'chapter-1',
        shortHeading: 'Letter from Elizabeth Webb',
        slug: 'chapter-1',
        isIntermediateTitle: false,
        isSequenced: false,
        hasNonSequenceTitle: true,
        sequenceNumber: null,
        nonSequenceTitle: 'Letter from Elizabeth Webb',
      },
    ],
    images: {
      square: [
  ...
  {
    id: 'c248c2e7-947b-4629-8296-0cdff67a6d99--updated',
    lang: 'en',
    document: {
    ...
    friend: {
      name: 'Isaac Penington',
      nameSort: 'Penington, Isaac',
      isCompilations: false,
    },
    isMostModernized: true,
    revision: '8fa2e54',
    audio: {
      reader: 'Jason R. Henderson',
      totalDuration: 53295.42,
      publishedDate: 'Fri Dec 04 2015 00:00:00 GMT-0500 (Eastern Standard Time)',
      parts: [
        {
          index: 0,
          editionId: 'c248c2e7-947b-4629-8296-0cdff67a6d99--updated',
          title: 'Chapter 1',
          utf8ShortTitle: 'Chapter I',
          duration: 2892.55,
          size: 29616809,
          sizeLq: 14529636,
          url:
    ...
    chapters: [
      {
        index: 0,
        id: 'chapter-1',
        shortHeading: 'Forward',
        slug: 'chapter-1',
        isIntermediateTitle: false,
        isSequenced: false,
        hasNonSequenceTitle: true,
        sequenceNumber: null,
        nonSequenceTitle: 'Forward',
      },
      {
        index: 1,
        id: 'chapter-2',
        shortHeading: 'Chapter I &#8212; Memoir of Isaac Penington',
        slug: 'chapter-2',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 1,
        nonSequenceTitle: 'Memoir of Isaac Penington',
      },
      {
        index: 2,
        id: 'chapter-3',
        shortHeading: 'The Way of Life and Death Made Manifest',
        slug: 'chapter-3',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 2,
        nonSequenceTitle: 'The Way of Life and Death Made Manifest and Set Before Men',
      },
      {
        index: 3,
        id: 'chapter-4',
        shortHeading: 'Principles Guiding Out of the Apostasy',
        slug: 'chapter-4',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
      ...
      },
      {
        index: 4,
        id: 'chapter-5',
        shortHeading: 'Chapter IV &#8212; The Axe Laid to the Root',
        slug: 'chapter-5',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 4,
        nonSequenceTitle: 'The Axe Laid to the Root',
      },
      {
        index: 5,
        id: 'chapter-6',
        shortHeading: 'Chapter V &#8212; The Scattered Sheep Sought After',
        slug: 'chapter-6',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 5,
        nonSequenceTitle: 'The Scattered Sheep Sought After',
      },
      {
        index: 6,
        id: 'chapter-7',
        shortHeading: 'Chapter VI &#8212; Babylon the Great',
        slug: 'chapter-7',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 6,
        nonSequenceTitle: 'Babylon the Great',
      },
      {
        index: 7,
        id: 'chapter-8',
        shortHeading: 'Chapter VII &#8212; The Holy Scriptures',
        slug: 'chapter-8',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 7,
        nonSequenceTitle: 'The Holy Scriptures',
      },
      {
        index: 8,
        id: 'chapter-9',
        shortHeading: 'The Authority and Government Christ Excluded',
        slug: 'chapter-9',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
      ...
      },
      {
        index: 9,
        id: 'chapter-10',
        shortHeading: 'Chapter IX &#8212; The New Covenant of the Gospel',
        slug: 'chapter-10',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 9,
        nonSequenceTitle: 'The New Covenant of the Gospel',
      },
      {
        index: 10,
        id: 'chapter-11',
        shortHeading: 'Prayer, Ministry, Wisdom, & Kingdom',
        slug: 'chapter-11',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 10,
        nonSequenceTitle: 'The Prayer, Ministry, Wisdom and Kingdom which are Spiritual',
      },
      {
        index: 11,
        id: 'chapter-12',
        shortHeading: 'Chapter XI &#8212; Some Directions to the Panting Soul',
        slug: 'chapter-12',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 11,
        nonSequenceTitle: 'Some Directions to the Panting Soul',
      },
      {
        index: 12,
        id: 'chapter-13',
        shortHeading: 'Chapter XII &#8212; Some Questions and Answers',
        slug: 'chapter-13',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 12,
        nonSequenceTitle: 'Some Questions and Answers',
      },
      {
        index: 13,
        id: 'chapter-14',
        shortHeading: 'Chapter XIII &#8212; The Sum and Substance of True Religion',
        slug: 'chapter-14',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 13,
        nonSequenceTitle: 'The Sum and Substance of True Religion',
      },
      {
        index: 14,
        id: 'chapter-15',
        shortHeading: 'Chapter XIV &#8212; The Two Seeds',
        slug: 'chapter-15',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 14,
        nonSequenceTitle: 'The Two Seeds',
      },
      {
        index: 15,
        id: 'chapter-16',
        shortHeading: 'Chapter XV &#8212; How to Discern the Teachings of Christ',
        slug: 'chapter-16',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 15,
        nonSequenceTitle: 'How to Discern the Teachings of Christ',
      },
      {
        index: 16,
        id: 'chapter-17',
        shortHeading: 'Chapter XVI &#8212; Letters of Isaac Penington',
        slug: 'chapter-17',
        isIntermediateTitle: false,
        isSequenced: true,
        hasNonSequenceTitle: true,
        sequenceNumber: 16,
        nonSequenceTitle: 'Letters of Isaac Penington',
      },
    ],
    images: {
      square: [
